...
RSpec.describe 'MealRecords', type: :request do
  ...
  describe 'GET /users/:id/meal_records' do
    before do
      ...
      create(:meal_record, start_time: Time.zone.now, user: @user, post_id: @post.id, post_name: @post.name, post_protein: @post.protein,
                           post_fat: @post.fat, post_carbo: @post.carbo, post_calorie: @post.calorie)
      create(:meal_record, start_time: Time.zone.now, user: @user, post_id: @post2.id, post_name: @post2.name, post_protein: @post2.protein,
